    ...
    <div>
      ...
      <div className='headerComp'>
        <div className='headerComp__component'>
          <Link to={'/'} ><img src="../../src/img/logoVazada.svg" alt="" />
          </Link>
          <h1>
            <Link to={'/Site'} className='headerComp__component-text'>Home</Link>
          </h1>
          <h1 style={{ cursor: 'pointer' }} onClick={() => setOpenModal(true)}>
            Sobre Nós
          </h1>
          <h1><Link to={'/galeria'} className='headerComp__component-text'>
            Galeria
          </Link>
          </h1>
          <h1>
